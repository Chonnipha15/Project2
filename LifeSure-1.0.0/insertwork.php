            ...
            <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="wimg" class="form-label">รูปภาพ</label>
                            <input type="file" name="wimg" required class="form-control" id="wimg">
                            <div class="form-text">กรุณาอัปโหลดรูปภาพ (เฉพาะ JPG, PNG, GIF, ขนาดไม่เกิน 2MB)</div>
                        </div>
                        <div class="mb-3">
                            <label for="wname" class="form-label">หัวข้อข่าวสาร</label>
                            <input type="text" name="wname" required class="form-control" id="wname">
                        </div>
                        <div class="mb-3">
                            <label for="wdetail" class="form-label">รายละเอียดข่าวสาร</label>
                            <textarea name="wdetail" required class="form-control" id="wdetail"
...
if (isset($_POST['Submit'])) {
    ...
    if (isset($_FILES['wimg']) && $_FILES['wimg']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = "INSERT INTO `work` (`w_name`, `w_detail`, `w_img`) 
                VALUES ('$wname', '$wdetail', '')";
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            if (move_uploaded_file($file_tmp, $new_file_name)) {
                ...
                $update_sql = "UPDATE `work` SET `w_img`='$new_file_name' WHERE `w_id`='$idauto'";
                mysqli_query($conn, $update_sql);

                echo "<script>alert('เพิ่มข้อมูลข่าวสารสำเร็จ'); window.location='work-admin.php';</script>";
            } else {
