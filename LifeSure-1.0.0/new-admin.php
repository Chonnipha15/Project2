         ...
         <div class="container-fluid team pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h1 class="display-4 mb-4">ข้อมูลข่าวสาร</h1>
                </div>
                <div style="display: flex; justify-content: flex-end;">
                    <a href="insertnew.php" class="btn btn-primary my-2" ><i class="bi bi-plus-circle-fill"></i>เพิ่มข้อมูลข่าวสาร</a><br>
                </div><br>
                ...
                <?php
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item min-height: auto">
                            <div class="team-img">
                            <img src="<?= $data['n_picture']; ?>?t=<?= time(); ?>" class="img-fluid h-50 rounded shadow" alt="">
                                <div class="team-icon d-flex justify-content-center gap-2">
                                <p><a class="btn btn-primary btn-sm-square rounded-pill" href="detailnew.php?nid=<?=$data['n_id'];?>"><i class="bi bi-file-earmark-text"></i></a></p>
                                <p><a class="btn btn-primary btn-sm-square rounded-pill" href="editnew.php?nid=<?=$data['n_id'];?>"><i class="bi bi-pencil-square"></i></a></p>
                                <a class="btn btn-primary btn-sm-square rounded-pill" href="deletenew.php?nid=<?= $data['n_id'];?>"><i class="bi bi-trash-fill"></i></a>
                                </div>
                            </div> 
                            <div class="team-title p-4 width: 100%">
                                <p class="mb-0"><?=$data['n_name'];?></p>
                            </div>
                        </div>   
                    </div> 
             <?php } ?>      
