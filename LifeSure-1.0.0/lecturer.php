         ...
         <div class="container-fluid team pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h1 class="display-4 mb-4">ข้อมูลอาจารย์ประจำสาขา</h1>
                </div>
                <div style="display: flex; justify-content: flex-end;">
                    <a href="insertlec.php" class="btn btn-primary my-2" ><i class="bi bi-plus-circle-fill"></i>เพิ่มข้อมูลอาจารย์</a><br>
                </div><br>
                ...
                <?php
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item min-height: auto">
                            <div class="team-img">
                            <img src="<?= $data['L_img']; ?>" class="img-fluid w-100 rounded shadow" alt="">
                                <div class="team-icon">
                                <p><a class="btn btn-primary btn-sm-square rounded-pill mb-2" href="detaillec.php?Lid=<?=$data['L_id'];?>"><i class="bi bi-file-earmark-text"></i></a></p>
                                <p><a class="btn btn-primary btn-sm-square rounded-pill mb-2" href="editlec.php?Lid=<?=$data['L_id'];?>"><i class="bi bi-pencil-square"></i></a></p>
                                <a class="btn btn-primary btn-sm-square rounded-pill mb-2" href="deletelec.php?Lid=<?= $data['L_id'];?>"><i class="bi bi-trash-fill"></i></a>
                                </div>
                            </div> 
                            <div class="team-title p-4 width: 100%">
                                <h4 class="mb-0"><?=$data['L_name'];?></h4>
                                <p class="mb-0"><?=$data['L_email'];?></p>
                                <p class="mb-0"><?=$data['L_tal'];?></p>
                            </div>
                        </div>   
                    </div> 
             <?php } ?>      
