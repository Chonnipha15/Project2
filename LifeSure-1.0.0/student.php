        ...
        <div class="container-fluid team pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h1 class="display-4 mb-4">ข้อมูลนิสิต</h1>
                    <p class="mb-0">สาขาคอมพิวเตอร์ธุรกิจ และสาขาวิชาธุรกิจดิจิทัลและระบบสารสนเทศ
                    </p>
                </div>
                <div class="row g-4">
                <div class="row">
...
<div style="display: flex; justify-content: flex-end;">
  <a href="student_insert.php?" class="btn btn-primary my-2" ><i class="bi bi-plus-circle-fill"></i>เพิ่มข้อมูลนิสิต</a>
</div>
  <table class="table table-striped table-hover">
      <thead>
    <tr>
      <th scope="col" width="20%">ชื่อ-สกุล</th>
      <th scope="col"width="16%">E-mail</th>
      <th scope="col"width="25%">เพิ่มเติม</th>
    </tr>
  </thead>
  <tbody>
    <?php 
    $sql = "SELECT * FROM `student`ORDER BY s_id DESC;";
	  $rs = mysqli_query($conn,$sql);
	  while($data = mysqli_fetch_array($rs)){
    ?>
    <tr>
      <td width="16%"><?= $data ['s_name']; ?></td>
      <td width="16%"><?= $data ['s_email']; ?></td>
      <td>
        <a href="student_edit.php?sid=<?= $data['s_id']; ?>" class="btn btn-primary" style="background-color: rgb(6, 100, 215)"><i class="bi bi-pen-fill" style= "color:rgb(242, 245, 247);"></i></a>
        <a href="student_delete.php?sid=<?= $data['s_id']; ?>" class="btn btn-danger" style="background-color:rgb(230, 41, 24)" onclick="return confirm('Are you sure you want to delete')"><i class="bi bi-trash-fill" style= "color: rgb(242, 245, 247);"></i></a>
        
  <i class="bi bi-house-door-fill" style="color: rgb(242, 245, 247);"></i>
</a><br>
      </td>
    </tr>
    <?php }
