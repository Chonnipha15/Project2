...
<div class="btn-group" role="group">
    ...
    <div class="team-item d-flex flex-column h-100">
        <div class="team-img">
            <img src="<?= $data['i_img']; ?>" class="img-fluid w-100 h-150 rounded shadow" alt="">
            <div class="team-icon">
                <p><a class="w-100 btn btn-primary rounded-pill py-2 px-4 mt-auto" href="detailit.php?iid=<?=$data['i_id'];?>"><i class="bi bi-file-earmark-text"></i></a></p>
            </div>
        </div> 
    </div>   
</div>
