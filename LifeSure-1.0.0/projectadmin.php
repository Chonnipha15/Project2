        ...
        <div class="d-flex">
            <div class="border-end border-primary pe-3">
                <a href="https://shorturl.asia/Lw9xf" class="text-muted small">
                    <i class="fas fa-map-marker-alt text-primary me-2"></i><BC-DBIS>
                </a>
            </div>
            <div class="ps-3 text-muted small">
                <i class="bi bi-emoji-laughing-fill text-primary me-2"></i>ยินดีต้อนรับคุณ <?=$_SESSION['aname'];?>
            </div>
        </div>
    </div>
...
// ดึงข้อมูลโปรเจคที่มี s_id เท่ากับ session
    ...
    <div class="container pb-5">
        ...
        <div class="row g-4">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php 
                    // วนลูปแสดงข้อมูลโปรเจคที่ดึงมา
                    while($data = mysqli_fetch_array($rs)){
                        // กำหนดสถานะจากฟิลด์ในตาราง project (สมมุติว่าเป็น 'status')
                        $status = $data['p_status']; // เปลี่ยนเป็นชื่อฟิลด์ที่ถูกต้องหากไม่ใช่ 'status'
                    ?>
                    <tr>
                        ...
                        <td width="20%" style="text-align: center; vertical-align: middle;"><?= $data['created_at']; ?></td> <!-- สมมุติว่า 'submit_date' เป็นฟิลด์วันที่ -->
                        <td width="14%" style="text-align: center; vertical-align: middle;"><?= $status; ?></td> <!-- แสดงสถานะ -->
                    </tr>
                    <?php 
                    }
                    ?>
