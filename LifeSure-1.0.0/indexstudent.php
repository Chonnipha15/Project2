        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <h1 class="display-4 mb-4">Project&Lecturer</h1>
                </div>
                <div class="row g-4 justify-content-center">
                        ...
                        <div class="service-item h-100">
                            ...
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4">อาจารย์ประจำสาขา</a>
                                    <p class="mb-4">รายละเอียดอาจารย์สาขาคอมพิวเตอร์ธุรกิจ</p>
                                    <a class="btn btn-primary rounded-pill py-2 px-4" href="lec-student.php">CLICK ME</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="service-item h-100">
                            ...
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4">ส่งข้อเสนอโปรเจค</a>
                                    <p class="mb-4">กรอกข้อมูลเลือกอาจารย์ที่ปรึกษาโปรเจคและส่งข้อเสนอโครงงาน</p>
                                    <a class="btn btn-primary rounded-pill py-2 px-4" href="sendpro.php">CLICK ME</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-item h-100">
                            ...
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4">การตอบกลับ</a>
                                    <p class="mb-4">ตรวจสอบข้อมูลการตอบกลับสำหรับโปรเจคของคุณ</p>
                                    <a class="btn btn-primary rounded-pill py-2 px-4" href="student_status.php">CLICK ME</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4">ประกาศรายชื่อคณะกรรมการสอบ</a>
                                    <p class="mb-4">ตรวจสอบข้อมูลรายชื่อการสอบสำหรับโปรเจคของคุณ</p>
                                    <a class="btn btn-primary rounded-pill py-2 px-4" href="tablepros.php">CLICK ME</a>
                                </div>
                            </div>
                        </div>
                    </div>
