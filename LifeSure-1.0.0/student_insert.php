    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">  
            ...
            <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    <div class="mb-5">
                        <h1 class="display-4 mb-0">เพิ่มข้อมูลนิสิต</h1>
                    </div>
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="sname" class="form-label">ชื่อ-สกุล</label>
                            <input type="text" name="sname" required class="form-control" id="sname">
                        </div>
                        <div class="mb-3">
                            <label for="semail" class="form-label">Email</label>
                            <input type="email" name="semail" required class="form-control" id="semail">
                        </div>

                        <div class="mb-3">
                            <label for="spassword" class="form-label">Password</label>
                            <input type="password" name="spassword" required class="form-control" id="spassword">
                        </div>
                        <button type="submit" name="Submit" class="btn btn-primary btn-md">เพิ่มข้อมูลนิสิต</button>
                    </form>
                </div>
            </div>
