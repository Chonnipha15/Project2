    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">  
            ...
            <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    <div class="mb-5">
                        <h1 class="display-4 mb-0">เพิ่มข้อมูลแอดมิน</h1>
                    </div>
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="aname" class="form-label">ชื่อ-สกุล</label>
                            <input type="text" name="aname" required class="form-control" id="aname">
                        </div>
                        <div class="mb-3">
                            <label for="aemail" class="form-label">Email</label>
                            <input type="email" name="aemail" required class="form-control" id="aemail">
                        </div>

                        <div class="mb-3">
                            <label for="apassword" class="form-label">Password</label>
                            <input type="password" name="apassword" required class="form-control" id="apassword">
                        </div>
                        <button type="submit" name="Submit" class="btn btn-primary btn-md">เพิ่มข้อมูล</button>
                    </form>
                </div>
            </div>
