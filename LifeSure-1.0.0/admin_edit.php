<?php
    ...
    $sql1 = "SELECT * FROM `adminn` WHERE a_id ='{$_GET['a_id']}' " ;
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">  
            ...
            <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    <div class="mb-5">
                        <h1 class="display-4 mb-0">แก้ไขข้อมูลแอดมิน</h1>
                    </div>
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label class="form-label">ชื่อ-สกุล</label>
                            <input type="text" name="aname" required value="<?=$data1['a_name'];?>"class="form-control" id="aname">
                        </div> 
                        <div class="mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" name="aemail" required value="<?=$data1['a_email'];?>" class="form-control" id="aemail">
                        </div>

                        <div class="mb-3">
                            <label  class="form-label">Password</label>
                            <input type="password" name="apassword" required value="<?=$data1['a_password'];?>" class="form-control" id="apassword">
                        </div>
                        <button type="submit" name="Submit" class="btn btn-primary btn-md">แก้ไขข้อมูล</button>
                    </form>
                </div>
            </div>
...
if(isset($_POST['Submit'])){
  ...
  if(empty($_FILES['aname']['name'])) {
      $sql1 = "UPDATE `adminn` SET `a_name` = '{$_POST['aname']}',`a_email` = '{$_POST['aemail']}' 
      WHERE `adminn`.`a_id` = '{$_GET['aid']}';";
