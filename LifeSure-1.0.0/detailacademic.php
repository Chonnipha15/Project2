...
<html lang="en">
    ...
    <body>
        ...
        <a href="performance" class="nav-item nav-link">ผลงานนิสิต</a>
        ...
        <!-- Modal Search End -->
         ...
         <div class="container-fluid bg-light about pb-5">
            <div class="container pb-5">
                ...
                <?php
	                include("connect.php");	
	                $sql = "SELECT * FROM academic WHERE A_id='{$_GET['Aid']}'";
	                $rs = mysqli_query($conn,$sql);
	                while ($data = mysqli_fetch_array($rs)){
                    ?>
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item-content bg-white rounded p-5 h-100">
                            <h4 class="display-4 mb-4"><?=$data['A_name'];?></h4>
                            <p class="text-dark"><strong></strong> <?=$data['A_detail'];?></p>
                        </div>
                    </div>
