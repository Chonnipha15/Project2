...
<div class="btn-group" role="group">
    ...
    <i class="bi bi-person-circle">Sign-in</i>
        ...
        <!-- Header Start -->
        <div class="container-fluid bg-breadcrumb" style="background-image: url('img/25.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 50px 0;">
        <div class="container text-center py-5" style="max-width: 900px; background-color: rgba(169, 169, 169, 0.48);">
    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Digital Business and Information Systems DBIS</h4>
    <h6 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">สาขาวิชาธุรกิจดิจิทัลและระบบสารสนเทศ</h6> 
</div>
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    ...
                    <h1 class="display-4 mb-4">Digital Business and Information Systems DBIS</h1>
                    <p class="mb-0">รหัสหลักสูตร : 25480211107173 หลักสูตรบริหารธุรกิจมหาบัณฑิต สาขาวิชาธุรกิจดิจิทัลและระบบสารสนเทศ
                ...
                <div class="row g-4 justify-content-center">
                        ...
                        <div class="service-item">
                            <div class="service-img">
                                ...
                                <div class="service-icon p-3" style="background: linear-gradient(to right, #ffcc00, #ff6600);"> 
                                    <i class="fa fa-star fa-2x" style="color: #ffffff;"></i> 
                                </div>
                            </div>
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4"><ความสำคัญของสาขา</a>
                                    <p class="mb-4">มุ่งผลิตบัณฑิตให้มีความรู้และความชำนาญทางด้าน ธุรกิจดิจิทัลและระบบสารสนเทศ 
                                        โดยเน้นการเรียนรู้ควบคู่กับการฝึกทักษะปฏิบัติจริงผ่านอุปกรณ์และระบบที่ทันสมัย พัฒนาบัณฑิตให้สามารถออกแบบ 
                                        ระบบสารสนเทศเพื่อธุรกิจ วิเคราะห์และจัดการข้อมูลดิจิทัล รวมถึงการประยุกต์ เทคโนโลยีดิจิทัล 
                                        กับกระบวนการบริหารจัดการให้สามารถใช้งานได้จริงในองค์กรธุรกิจ
                                    </p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="img/22.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="service-icon p-3" style="background: linear-gradient(to right, #ffcc00, #ff6600);">
                                    <i class="fa fa-lightbulb fa-2x" style="color: #ffffff;"></i>
                                </div>
                            </div>
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                <a href="#" class="d-inline-block h4 mb-4 underline-blue">ความสำคัญของสาขา</a>
                                    <p class="mb-4">มุ่งเน้นให้บัณฑิตมีความรู้และความเข้าใจในกระบวนการสร้างและประยุกต์ใช้องค์ความรู้ด้านธุรกิจดิจิทัลและระบบสารสนเทศ 
                                        โดยเน้นหลักการและแนวคิดที่ครอบคลุมทั้งการวิเคราะห์ข้อมูลธุรกิจ,การพัฒนาเทคโนโลยีดิจิทัล,การออกแบบระบบสารสนเทศ 
                                        และการจัดการนวัตกรรมดิจิทัล เพื่อนำไปประยุกต์ใช้ในการพัฒนาองค์กรให้ทันต่อกระแสการเปลี่ยนแปลงเศรษฐกิจดิจิทัล 
                                        </p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="img/23.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="service-icon p-3" style="background: linear-gradient(to right, #ffcc00, #ff6600);">
                                    <i class="fa fa-flag-checkered fa-2x" style="color: #ffffff;"></i>
                                </div>
                            </div>
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4">วัตถุประสงค์ของหลักสูตร </a>
                                    <p class="mb-4">1.มีความรู้ความสามารถ และสามารถบูรณาการวิทยาการต่าง ๆ ที่เกี่ยวข้องกับระบบสารสนเทศทาง
                                        ธุรกิจได้อย่างมีประสิทธิภาพ
                                        2.มีความคิดสร้างสรรค์งานวิจัยให้เกิดนวัตกรรมและทฤษฎีใหม่ที่มีคุณค่าทางวิชาการด้านระบบสารสนเทศทางธุรกิจ ทั้งในระดับประเทศและสากล
                                        3.มีคุณธรรม จริยธรรม และนําคุณประโยชน์มาสู่สังคม ตลอดจนความรับผิดชอบต่อสังคม
                                    </p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="img/26.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="service-icon p-3" style="background: linear-gradient(to right, #ffcc00, #ff6600);">
                                    <i class="fa fa-briefcase fa-2x" style="color: #ffffff;"></i>
                                </div>
                            </div>
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4">อาชีพที่สามารถประกอบได้หลังสำเร็จการศึกษา</a>
                                    <style>
                                .pre-line {
                                    white-space: pre-line;
                                }
                            </style>
                                  <p class="pre-line">1. นักวิเคราะห์ข้อมูล
                                        2. นักวิเคราะห์ระบบ
                                        3. นักออกแบบและพัฒนาธุรกิจดิจิทัล
                                        4. ผู้ประกอบการทางด้านธุรกิจดิจิทัล
                                        5. ผู้ดูแลด้านเทคนิค
                                        6. นักพัฒนาเว็บไซต์ 
                                        7. ผู้ดูแลระบบฐานข้อมูล 
                                        8. ครู/ อาจารย์ด้านคอมพิวเตอร์
...
.section-title {
        font-size: 25px; /* ปรับขนาดตัวอักษรให้เล็กลง */
        font-weight: 300; /* ลดความหนาของตัวอักษร */
}
.curriculum-table {
    margin-left: 30%; /*ระยะห่างขอบซ้ายพื้นที่รอบนอก */
    margin-right: 30%; /*ระยะห่างขอบขวาพื้นที่รอบนอก */
}
.curriculum-table {
    width: 78%; /* กำหนดความกว้างของตารางเป็น 50% ของพื้นที่ผู้ปกครอง */
    margin: 0 auto; /* จัดให้อยู่กึ่งกลาง */
    
}
.section-title {
    margin-left: 12%; /*ระยะห่างขอบซ้ายพื้นที่รอบนอก */
}
strong {
    margin-left: 12%; /*ระยะห่างขอบซ้ายพื้นที่รอบนอก */
}
...
ul {
    margin-left: 17%; /*ระยะห่างขอบซ้ายพื้นที่รอบนอก */
}
.section-title1 {
    margin-left: 17%; /*ระยะห่างขอบซ้ายพื้นที่รอบนอก */
}
...
<head>
    <meta charset="UTF-8">
    <title>หลักสูตรบริหารธุรกิจบัณฑิต สาขาวิชาธุรกิจดิจิทัลและระบบสารสนเทศ</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <div class="container">
        <h1 class="title">หลักสูตรบริหารธุรกิจบัณฑิต สาขาวิชาธุรกิจดิจิทัลและระบบสารสนเทศ</h1>
        <h2 class="subtitle">(หลักสูตรปรับปรุง พ.ศ. 2565)</h2><br>
        ...
        <div class="program-info">
            <p><strong>ชื่อภาษาไทย:</strong> หลักสูตรบริหารธุรกิจบัณฑิต สาขาวิชาธุรกิจดิจิทัลและระบบสารสนเทศ</p>
            <p><strong>ชื่อภาษาอังกฤษ:</strong> Bachelor of Business Administration Program in Digital Business and Information Systems</p>
        </div><br>

        <h2 class="section-title">ชื่อปริญญาและสาขาวิชา</h2>
        <div class="degree-info">
            <p><strong>ภาษาไทย (ชื่อเต็ม):</strong> บริหารธุรกิจบัณฑิต (ธุรกิจดิจิทัลและระบบสารสนเทศ)</p>
            <p><strong>ภาษาไทย (ชื่อย่อ):</strong> บธ.บ. (ธุรกิจดิจิทัลและระบบสารสนเทศ)</p>
            <p><strong>ภาษาอังกฤษ (ชื่อเต็ม):</strong> Bachelor of Business Administration (Digital Business and Information Systems)</p>
            <p><strong>ภาษาอังกฤษ (ชื่อย่อ):</strong> B.B.A. (Digital Business and Information Systems)</p>
        </div><br>
...
<h2 class="section-title1">คุณสมบัติของผู้เข้าศึกษา</h2>
        ...
        <!-- Testimonial Start -->
        <br><hr><br><div class="container-fluid testimonial pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-primary">Mahasarakham University</h4>
                    <h1 class="display-4 mb-4">มหาวิทยาลัยมหาสารคาม</h1>
                    <p class="mb-0">ปรัชญา “ พหูนํ ปณฺฑิโต ชีเว ” ผู้มีปัญญาพึงเป็นอยู่เพื่อมหาชน ปณิธาน 
                        มหาวิทยาลัยมหาสารคามเป็นสถาบันที่มุ่งมั่นในการสั่งสมแสวงหาความเป็นเลิศทางวิชาการ 
                        โดยศึกษาภูมิปัญญาท้องถิ่น ผสมผสานกับวิทยาการที่เป็นสากลให้เกิดความงอกงามทางสติปัญญา
                        สามารถพัฒนาตนเองให้เพียบพร้อมด้วยวิชาการ จริยธรรมและคุณธรรม
                    </p>
                </div>
...
<style>
    .carousel-inner img {
        width: 60%; /* ปรับให้เหลือ 70% (เล็กลง 30%) */
        margin: auto; /* จัดภาพให้อยู่กึ่งกลาง */
    }
</style>
