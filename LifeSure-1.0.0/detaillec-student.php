...
<html lang="en">
    ...
    <div class="navbar-nav mx-0 mx-lg-auto d-flex align-items-center">
        <a href="index-student.php" class="nav-item nav-link active">หน้าหลัก</a>
        ...
        <!-- Modal Search End -->
         ...
         <div class="container-fluid bg-light about pb-5">
            <div class="container pb-5">
                ...
                <?php
	                include("connect.php");	
	                $sql = "SELECT * FROM lecturer WHERE L_id='{$_GET['Lid']}'";
	                $rs = mysqli_query($conn,$sql);
	                while ($data = mysqli_fetch_array($rs)){
                    ?>
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item-content bg-white rounded p-5 h-100">
                            <h2 class="display-4 mb-4">รายละเอียดข้อมูลอาจารย์</h2>
                            <p class="text-dark"><strong>ภาระการสอน:</strong> <?=$data['L_teaching'];?></p>
                            <p class="text-dark"><strong>ประวัติการศึกษา:</strong> <?=$data['L_exper'];?></p>
                        </div>
                    </div>
                            ...
                            <div class="row g-4 justify-content-center">
                                ...
                                <div class="col-sm-20">
                                    <div class="counter-item bg-light rounded p-3 h-100">
                                        <h4 class="mb-0 text-dark"><?=$data['L_name'];?></h4>
                                        <h4 class="mb-0 text-dark">Email : <?=$data['L_email'];?></h4>
                                        <h4 class="mb-0 text-dark">เบอร์โทรติดต่อ : <?=$data['L_tal'];?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
