    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">  
            ...
            <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    <div class="mb-5">
                        <h1 class="display-4 mb-0">เพิ่มข้อมูลผลงานนิสิต</h1>
                    </div>
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="col-12">
                                <label for="Plink">แนบลิงค์</label>
                                <input type="url" id="Plink" name="Plink" placeholder="กรอก URL ของคุณ" required>    
                        </div>

                        <div class="mb-3">
                            <label for="nname" class="form-label">ชื่อผลงาน</label>
                            <input type="text" name="Pname" required class="form-control" id="nname">
                        </div>

                        <button type="submit" name="Submit" class="btn btn-primary btn-md">เพิ่มข้อมูลผลงานนิสิต</button>
                    </form>
                </div>
            </div>
...
if (isset($_POST['Submit'])) {
    ...
    $Plink = mysqli_real_escape_string($conn, $_POST['Plink']);  // รับลิงก์จากฟอร์ม

    // ตรวจสอบว่าได้กรอกลิงก์หรือไม่
    if (empty($Plink)) {
        echo "กรุณากรอกลิงก์";
    } else {
        // เพิ่มข้อมูลลงในฐานข้อมูล โดยใช้ลิงก์ในฟิลด์ P_img
        $sql = "INSERT INTO `performance` (`P_name`, `P_link`) 
                VALUES ('$Pname','$Plink')";

        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('เพิ่มข้อมูลผลงานนิสิตสำเร็จ'); window.location='performance-admin.php';</script>";
        } else {
