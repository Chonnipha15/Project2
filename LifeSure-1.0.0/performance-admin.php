         ...
         <div class="container-fluid team pb-5">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h1 class="display-4 mb-4">ผลงานนิสิต</h1>
                </div>
                <div style="display: flex; justify-content: flex-end;">
                    <a href="insertperformance.php" class="btn btn-primary my-2" ><i class="bi bi-plus-circle-fill"></i>เพิ่มข้อมูลผลงานนิสิต</a><br>
                </div><br>
                ...
                <?php
                            ...
                            $sql = "SELECT * FROM `performance` WHERE P_id ";
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="<?= $data['P_link']; ?>" target="_blank"><?= $data['P_link']; ?></a>
                                                    </td>
                                <div class="team-icon d-flex justify-content-center gap-2">
                                <p><a class="btn btn-primary btn-sm-square rounded-pill" href="editperformance.php?Pid=<?=$data['P_id'];?>"><i class="bi bi-pencil-square"></i></a></p>
                                <a class="btn btn-primary btn-sm-square rounded-pill" href="deleteperformance.php?Pid=<?= $data['P_id'];?>"><i class="bi bi-trash-fill"></i></a>
                                </div>
                            </div> 
                        </div>   
                    </div> 
