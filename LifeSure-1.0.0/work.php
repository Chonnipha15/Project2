                ...
                <?php
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item min-height: auto">
                            <div class="team-img">
                            <img src="<?= $data['w_img']; ?>" class="img-fluid w-100 rounded shadow" alt="">
                                <div class="team-icon">
                                <p><a class="w-100 btn btn-primary rounded-pill py-2 px-4 mt-auto" href="detailwork.php?wid=<?=$data['w_id'];?>"><i class="bi bi-file-earmark-text"></i></a></p>
                                </div>
                            </div> 
                        </div>   
                    </div> 
