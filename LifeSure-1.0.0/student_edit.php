<?php
    ...
    $sql1 = "SELECT * FROM student WHERE s_id ='{$_GET['sid']}' " ;
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">  
            ...
            <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    <div class="mb-5">
                        <h1 class="display-4 mb-0">แก้ไขข้อมูลนิสิต</h1>
                    </div>
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label class="form-label">ชื่อ-สกุล</label>
                            <input type="text" name="sname" required value="<?=$data1['s_name'];?>"class="form-control" id="sname">
                        </div> 
                        <div class="mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" name="semail" required value="<?=$data1['s_email'];?>" class="form-control" id="semail">
                        </div>

                        <div class="mb-3">
                            <label  class="form-label">Password</label>
                            <input type="password" name="spassword" required value="<?=$data1['s_password'];?>" class="form-control" id="spassword">
                        </div>
                        <button type="submit" name="Submit" class="btn btn-primary btn-md">แก้ไขข้อมูลนิสิต</button>
                    </form>
                </div>
            </div>
...
if(isset($_POST['Submit'])){
  ...
  if(empty($_FILES['Lpicture']['name'])) {
      $sql = "UPDATE `student` SET `s_name` = '{$_POST['sname']}',`s_email` = '{$_POST['semail']}' 
      WHERE `student`.`s_id` = '{$_GET['sid']}';";
