...
<html lang="en">
    ...
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            <h4 class="text-primary">ข้อมูลอาจารย์ประจำสาขา</h4>
            <h1 class="display-4 mb-4">คอมพิวเตอร์ธุรกิจ</h1>
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
            ...
            ?>
                <div class="testimonial-item bg-light rounded" style="min-height: auto;">
                    <div class="row g-0">
                        <div class="col-4 col-lg-4 col-xl-3">
                            <div class="h-100">
                                <img src="<?= htmlspecialchars($data['L_img']); ?>" class="img-fluid w-100 rounded shadow" alt="Profile Image">
                            </div>
                        </div>
                        <div class="col-8 col-lg-8 col-xl-9">
                            <div class="d-flex flex-column my-auto text-start p-4">
                                <h4 class="text-dark mb-0"><?= htmlspecialchars($data['L_name']); ?></h4>
                                <p class="mb-3">เบอร์โทรติดต่อ : <?= htmlspecialchars($data['L_tal']); ?></p>
                                ...
                                <p class="mb-0">Email : <?= htmlspecialchars($data['L_email']); ?></p>
                                <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a class="btn btn-primary rounded-pill py-2 px-4" href="detaillec-student.php?Lid=<?=$data['L_id'];?>">รายละเอียดข้อมูลอาจารย์</a>
                                </div>
                            </div>
                            </div>
                        </div>
