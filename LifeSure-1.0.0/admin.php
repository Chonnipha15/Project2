...
<html lang="en">
    ...
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            <h4 class="text-primary">ข้อมูลแอดมิน</h4>
            <h1 class="display-4 mb-4">BC-DBIT</h1>
            <p class="mb-0">คณะการบัญชีและการจัดการ</p>
        </div>
        <div style="display: flex; justify-content: flex-end;">
                    <a href="admin_insert.php" class="btn btn-primary my-2" ><i class="bi bi-plus-circle-fill"></i>เพิ่มข้อมูลแอดมิน</a><br>
                </div><br>
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
            ...
            ?>
                <div class="testimonial-item bg-light rounded position-relative" style="min-height: auto;">
    <div class="row g-0">
        <div class="col-4 col-lg-4 col-xl-3 position-relative">
            <div class="team-icon position-absolute bottom-0 start-0 p-2">
                <p>
                    <a class="btn btn-primary btn-sm-square rounded-pill mb-2" href="admin_edit.php?a_id=<?= $data['a_id']; ?>">
                        <i class="bi bi-pencil-square"></i>
                    </a>
                </p>
                <a class="btn btn-primary btn-sm-square rounded-pill mb-2" href="admin_delete.php?a_id=<?= $data['a_id']; ?>">
        ...
        <div class="col-8 col-lg-8 col-xl-9">
            <div class="d-flex flex-column my-auto text-start p-4">
                <h4 class="text-dark mb-0"><?= htmlspecialchars($data['a_name']); ?></h4>
                <p class="mb-3">รหัสแอดมิน: <?= htmlspecialchars($data['a_id']); ?></p>
                ...
                <p class="mb-0">Email : <?= htmlspecialchars($data['a_email']); ?></p>
            </div>
        </div>
    </div>
</div>
