            ...
            <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="Aimg" class="form-label">รูปภาพ</label>
                            <input type="file" name="Aimg" required class="form-control" id="Aimg">
                            <div class="form-text">กรุณาอัปโหลดรูปภาพ (เฉพาะ JPG, PNG, GIF, ขนาดไม่เกิน 2MB)</div>
                        </div>
                        <div class="mb-3">
                            <label for="Aname" class="form-label">หัวข้อข่าวสาร</label>
                            <input type="text" name="Aname" required class="form-control" id="Aname">
                        </div>
                        <div class="mb-3">
                            <label for="Adetail" class="form-label">รายละเอียดข่าวสาร</label>
                            <textarea name="Adetail" required class="form-control" id="Adetail"
...
if (isset($_POST['Submit'])) {
    ...
    if (isset($_FILES['Aimg']) && $_FILES['Aimg']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = "INSERT INTO `academic` (`A_name`, `A_detail`, `A_img`) 
                VALUES ('$Aname', '$Adetail', '')";
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            if (move_uploaded_file($file_tmp, $new_file_name)) {
                ...
                $update_sql = "UPDATE `academic` SET `A_img`='$new_file_name' WHERE `A_id`='$idauto'";
                mysqli_query($conn, $update_sql);

                echo "<script>alert('เพิ่มข้อมูลข่าวสารสำเร็จ'); window.location='academic-admin.php';</script>";
            } else {
